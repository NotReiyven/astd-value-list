...
function TiltCard({
  ...
  return (
    ...
    >
      ...
      {/* Accent Line */}
      <div
        className="absolute top-0 left-0 right-0 h-[4px] z-20 rounded-t-[12px]"
...
export function HomeChannel() {
  ...
  const parsedChangelog = useMemo(() => {
    ...
    for (let i = 0; i < changelog.length; i++) {
      ...
      const isHeader =
        i + 1 < changelog.length &&
        changelog[i + 1].trim().match(/^[-_]{3,}$/);
  ...
  // --- Custom Credit Images --- //

  const foundedByIcon =
    "https://media.discordapp.net/attachments/1538970612947615744/1543314410746155150/image.png?ex=6a946b0c&is=6a93198c&hm=51430aa6e9cd47b68758c044e97cf0489e0bbaabd594aa63189d08d49450d890&=&format=webp&quality=lossless";

  const valueListTeamIcon =
    "https://media.discordapp.net/attachments/1538970612947615744/1543314384023986226/image.png?ex=6a946b06&is=6a931986&hm=60138cd9ac5603cc1387293edb084c6dc68b972b154fb59d6de4ac4861e4e160&=&format=webp&quality=lossless";

  const qualityAssuranceIcon =
    "https://media.discordapp.net/attachments/1538970612947615744/1543314746856575107/thumb-up-emoticon.png?ex=6a946b5d&is=6a9319dd&hm=1460be857471c25b9e78c5292074bdfc01ce9ae89f27cfc985187f064386af73&=&format=webp&quality=lossless";

  const creditsBottomImage =
    "https://media.discordapp.net/attachments/1538970612947615744/1543311617964384398/noFilter.png?ex=6a946873&is=6a9316f3&hm=6d880653890bffc43446aaae20d6fa3da0854ea129516382498a674b48498124&=&format=webp&quality=lossless";
      ...
      <div className="flex-shrink-0 px-4 md:px-6 py-3 border-b border-[rgba(255,255,255,0.04)] bg-[#2B2D31]">
        <div className="flex bg-[#1E1F22] rounded-[6px] p-1 border border-[rgba(255,255,255,0.04)] w-full md:w-fit">
          ...
          <button
            ...
            className={`flex-1 md:flex-none px-6 py-1.5 rounded-[4px] text-[12px] font-bold transition-all ${
              activeHomeTab === "info"
          ...
          <button
            onClick={() => setActiveHomeTab("credits")}
            className={`flex-1 md:flex-none px-6 py-1.5 rounded-[4px] text-[12px] font-bold transition-all ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5 animate-fade-in pb-4">
              ...
              <div className="p-5 md:p-6 flex flex-col h-full relative z-10">
                ...
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-9 h-9 rounded-[8px] flex items-center justify-center bg-[#1E1F22] border border-[rgba(255,255,255,0.06)] shadow-inner flex-shrink-0">
                    <Sparkles className="w-[18px] h-[18px] text-[#5865F2]" />
                  </div>

                  <h3 className="text-[15px] font-extrabold text-[#F2F3F5] tracking-tight leading-tight uppercase">
                    General Information
                  </h3>
                </div>

                <p className="text-[13px] text-[#DBDEE1] leading-[1.65] mb-6">
                  Everything shown in this Value List is an estimation from
                  this Value List's Team made from community's trades, our
                  changes can be innacurate sometimes, although, this Value
                  List is currently the most reliable source of values for
                  ASTD.
                </p>
                ...
                <div className="mt-auto flex flex-col gap-3">
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-1.5 text-[12px] font-bold text-white bg-[#5865F2] hover:bg-[#4752C4] px-4 py-2.5 rounded-[6px] transition-colors active:scale-[0.98]"
                  >
                    Join the Value List Discord
                    <ExternalLink className="w-3.5 h-3.5" />
                  </a>

                  <p className="text-[11px] text-[#949BA4] text-center">
                    Think any information is wrong? Make a Support Ticket in
                    our Discord!
                  </p>
            ...
            <TiltCard color="#8b7a7a">
              <div className="p-5 md:p-6 flex flex-col h-full relative z-10">
                ...
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-9 h-9 rounded-[8px] flex items-center justify-center bg-[#1E1F22] border border-[rgba(255,255,255,0.06)] shadow-inner flex-shrink-0">
                    <ShieldAlert className="w-[18px] h-[18px] text-[#FAA61A]" />
                  </div>

                  <h3 className="text-[15px] font-extrabold text-[#F2F3F5] tracking-tight leading-tight uppercase">
                    Value List Team's Note
                  </h3>
                </div>

                <p className="text-[13px] text-[#DBDEE1] leading-[1.65] mb-4">
                  Recently, it has been common of traders on win/loss, in our
                  discord server, associating one bad offer/trade, which can
                  come from a multitude of reasons, with the specific unit
                  dropping, creating a trend which other traders follow,
                  causing the unit to be panic traded and dropped.
                </p>
                ...
                <div className="bg-[#111214] p-3.5 rounded-[8px] border border-[rgba(250,166,26,0.2)] mb-4">
                  <p className="text-[11.5px] text-[#FAA61A] font-medium leading-relaxed italic">
                    "We would like to remind such behavior causes the market
                    to be extremely unstable, causing many units to crash
                    without any previous reason, so we from the Value List
                    Team recommend traders to analyse the market before
                    wrongly assuming the situation of the unit."
                  </p>
                </div>

                <div className="mt-auto pt-4 border-t border-[rgba(255,255,255,0.04)]">

                  <span className="text-[11px] font-bold text-[#80848E] uppercase tracking-widest">
                    Recommendation:
                  </span>

                  <span className="ml-2 text-[12px] text-[#DBDEE1]">
                    Stay calm and verify trades with the analyzer!
                  </span>
          ...
          <div className="animate-fade-in pb-4">
            ...
            <div className="flex items-center justify-between mb-5 bg-[#2B2D31] p-4 rounded-[10px] border border-[rgba(255,255,255,0.04)] shadow-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="w-8 h-8 rounded-full bg-[rgba(35,165,89,0.1)] flex items-center justify-center border border-[rgba(35,165,89,0.2)]">
                  <FileText className="w-4 h-4 text-[#23a559]" />
                </div>

                <h3 className="text-[16px] font-black text-[#F2F3F5] tracking-tight uppercase">
                  Latest Patch Notes
                </h3>
        ...
        {activeHomeTab === "credits" && (
          <div className="animate-fade-in pb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
              ...
              <TiltCard
                color="#8b7a7a"
                className="col-span-1 md:col-span-2 xl:col-span-3 mb-2 flex-row items-center sm:items-stretch overflow-hidden"
              >
                ...
                <div className="p-6 relative z-10 flex flex-col sm:flex-row items-center gap-6 w-full">
                  ...
                  <div
                    onClick={() =>
                      setDevSpin((prev) => prev + 360)
                    }
                    className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-full border-[3px] border-[#2B2D31] shadow-[0_0_0_2px_rgba(237,66,69,0.4),_0_8px_24px_rgba(237,66,69,0.3)] overflow-hidden shrink-0 cursor-pointer"
                    style={{
                      transform: `rotateY(${devSpin}deg)`,
                      transition:
                  ...
                  >
                    ...
                    <img
                      src="https://media.discordapp.net/attachments/949561628704268288/1543300068528889926/FB_IMG_1788021799554.jpg?ex=6a945db1&is=6a930c31&hm=ff7d53bb654ac442e28e91901bb33394c228b4dbcd5f792f9ffe48474629e357&=&format=webp"
                      alt="Reiyven"
                  ...
                  <div className="flex flex-col items-center sm:items-start text-center sm:text-left flex-1">
                    ...
                    <div className="flex flex-wrap justify-center sm:justify-start items-center gap-2 mb-1">
                      ...
                      <h4 className="text-[22px] font-black text-[#F2F3F5] tracking-tight">
                        Reiyven
                      </h4>
                    ...
                    <p className="text-[13px] font-medium text-[#949BA4] mb-3">
                      Raven • 3rd Year BSCS @ PHILIPPINES
                    </p>

                    <p className="text-[13px] text-[#DBDEE1] leading-relaxed max-w-2xl">
                      Architect and lead engineer of the ASTD Value List web
                      platform. Combined a background in computer science and
                      game development to build the responsive layout,
                      advanced parsing engine, and trading tools for the
                      community.
                    </p>
              ...
              <TiltCard color="#8b7a7a">
                ...
                <div className="p-6 relative z-10 flex flex-col items-center text-center h-full">
                  ...
                  <h4 className="text-[11px] font-bold uppercase tracking-wider text-[#949BA4] mb-3">
                    List Founded By
                  </h4>
              ...
              >
                ...
                <div className="p-6 relative z-10 flex flex-col items-center text-center">
                  ...
                  <h4 className="text-[11px] font-bold uppercase tracking-wider text-[#949BA4] mb-4">
                    Ex-Staff Contributors
                  </h4>
            ...
            <div className="mt-6 flex justify-center">
              ...
              <div className="relative w-full max-w-5xl overflow-hidden rounded-[12px] border border-[rgba(255,255,255,0.06)] bg-[#2B2D31] shadow-sm group">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, transparent, #8b7a7a, transparent)"
                  }}
                />

                <img
                  src={creditsBottomImage}
                  alt="ASTD Value List"
