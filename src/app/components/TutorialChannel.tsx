  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-[#313338] h-full select-none">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-4 md:p-6">
        ...
        {/* ============================================================ */}
        {/* PLATFORM GUIDE (SpotlightCards - No Tilt) */}
        {/* ============================================================ */}
        {activeTab === "platform" && (
          <div className="animate-fade-in pb-4">
            
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-[#2B2D31] border border-[rgba(255,255,255,0.06)] rounded-[8px] p-4 mb-4 shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-[14px] font-bold text-[#F2F3F5]">Platform Guidelines</span>
                  <span className="text-[12px] text-[#949BA4] mt-0.5">Review how values, tags, and calculations are handled.</span>
                </div>
              </div>
              <button 
                onClick={() => window.dispatchEvent(new Event("open-welcome-modal"))}
                className="px-4 py-2 bg-[#1E1F22] hover:bg-[#3F4147] text-[#DBDEE1] text-[12px] font-semibold rounded-[4px] transition-all border border-[rgba(255,255,255,0.04)] active:scale-[0.98] whitespace-nowrap shadow-sm"
              >
                View Rules
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-5">
              ...
              {/* Col 1: Tools & Navigation */}
              <div className="flex flex-col gap-4 md:gap-5">
                <SpotlightCard color="#8b7a7a" className="flex-auto min-h-[220px]">
                  <div className="p-5 md:p-6 flex flex-col h-full relative z-10">
                    ...
                    <p className="text-[13px] text-[#DBDEE1] leading-[1.65] mb-6">
                      Calculates value differences & average stats. Open the panel and start typing to instantly find and compare units.
                    </p>
                ...
                <SpotlightCard color="#8b7a7a" className="flex-auto min-h-[220px]">
                  <div className="p-5 md:p-6 flex flex-col h-full relative z-10">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-9 h-9 rounded-[8px] flex items-center justify-center bg-[#1E1F22] border border-[rgba(255,255,255,0.06)] shadow-inner flex-shrink-0">
                        <Smartphone className="w-[18px] h-[18px] text-[#00A8FC]" />
                      </div>
                    ...
                    <p className="text-[13px] text-[#DBDEE1] leading-[1.65] mb-5">
                      Navigate the entire app with quick, edge-to-edge screen swipes.
                    </p>
              ...
              <div className="flex flex-col gap-4 md:gap-5">
                ...
                <SpotlightCard color="#8b7a7a" className="flex-auto min-h-[220px]">
                  <div className="p-5 md:p-6 flex flex-col h-full relative z-10">
                    ...
                    <div
                      className="mt-auto bg-[#1E1F22] border border-[rgba(255,255,255,0.06)] rounded-[8px] p-3 flex flex-col gap-3 cursor-pointer transition-all hover:border-[#23a559] active:scale-[0.98] relative shadow-sm overflow-hidden"
                      onClick={(e) => handleSandboxClick(e, "give")}
                      onContextMenu={(e) => handleSandboxClick(e, "get")}
                    >
                      {/* Sparks Rendering */}
                      {sparks.map(s => (
                        <span 
                      ...
                      <div className="flex items-center justify-between border-t border-[rgba(255,255,255,0.04)] pt-2 mt-1 z-10 relative pointer-events-none">
                        <span className="text-[9px] font-bold text-[#80848E] uppercase tracking-wider hidden md:block">
                          <span className="text-[#FAA61A]">[L-Click]</span> Give
                        </span>
                        <span className="text-[9px] font-bold text-[#80848E] uppercase tracking-wider hidden md:block">
                          <span className="text-[#5865F2]">[R-Click]</span> Get
                        </span>
                        <span className="text-[9px] font-bold text-[#80848E] uppercase tracking-wider md:hidden w-full text-center">
                          <span className="text-[#FAA61A]">[Tap]</span> For Action Menu
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <SpotlightCard color="#8b7a7a" className="flex-1 min-h-[220px]">
                  <div className="p-5 md:p-6 flex flex-col h-full relative z-10">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-9 h-9 rounded-[8px] flex items-center justify-center bg-[#1E1F22] border border-[rgba(255,255,255,0.06)] shadow-inner flex-shrink-0">
              ...
              {/* Col 3: View Modes */}
              <SpotlightCard color="#8b7a7a" className="min-h-[220px]">
                <div className="p-5 md:p-6 flex flex-col h-full relative z-10">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-9 h-9 rounded-[8px] flex items-center justify-center bg-[#1E1F22] border border-[rgba(255,255,255,0.06)] shadow-inner flex-shrink-0">
